...
//		file.transferTo(new File(uploadPath + file.getOriginalFilename()));
	...
	public String listPosts(
		...
		PageNavigator navi = new PageNavigator(countPerPage, 
												pagePerGroup, 
												posts.getTotalPages(), 
												posts.getNumber(), 
	...
	public String editPost(
		...
		if (post.getUser().getId() == loginUser.getId()) {
			postService.updatePost(postId, postUpdateDto.toEntity(), file);
		}
	...
	// 첨부파일 삭제
	@GetMapping("posts/{postId}/deleteFile/{fileAttachmentId}")
	public String deleteFile(
			@PathVariable(name = "postId") Long postId,
			@PathVariable(name = "fileAttachmentId") Long fileAttachmentId) {
		postService.deleteFile(postId, fileAttachmentId);
